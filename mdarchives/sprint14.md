successfully downloaded text file (SHA: 5fe90c57d65616665784fd865b8513a369c39c1d)
...
|---|---|---|
| **S14-1** · POST /api/campaigns role guard | ✅ DONE | `requireRole('advertiser')` added to `POST /` in `campaigns.js`; `advertiser_id` stamped from `req.user.linked_entity_id` stamped |
