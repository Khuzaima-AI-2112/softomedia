# Sprint 20 – Retailer → Campaign Flow Stabilization

> NOTE: This file was moved from `docs/sprint-12-plan.md` into `current_sprint/` to serve as the active sprint plan.
