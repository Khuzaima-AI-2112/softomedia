...
> The specific manifest of required Playwright test-ids is defined in the canonical Page Object Model (POM) locator dictionaries at [tests/demo_wizard/*_locators.js](file:///c:/Users/ChrisFro/Desktop/EmoGini/softomedia-live2026/tests/demo_wizard/).
...
tests/
  fixtures/
    personas.js                            ← Single Source of Truth for personas/auth
    factories.js                           ← Shared data generators
    seed-health.js                         ← Loud verification gate
    mock-routes.js                         ← Shared page.route() helpers
  firestore-rules/
    rules.test.js                          ← Gap 4: Firestore Rules
  demo_wizard/
    demo.fixtures.js                       ← loginAs + authReset (depends on personas.js)
    00_seed.setup.js                       ← Uses seed-health.js for verification
...
*   **Remediation:** See the canonical Page Object Model (POM) locator dictionaries at [tests/demo_wizard/*_locators.js](file:///c:/Users/ChrisFro/Desktop/EmoGini/softomedia-live2026/tests/demo_wizard/) for the exhaustive manifest of the exact UI hooks required for Playwright to interact with the existing architecture.
