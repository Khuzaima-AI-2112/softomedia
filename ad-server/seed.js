...
// Default password for all demo users — supports switching between all 4 personas in testing
...
async function buildSeedData() {
    ...
    return {
        ...
        // All 4 personas share the same password ('password') for easy role-switching during testing.
        // The dashboard persona switcher changes the active role client-side without re-login.
        users: [
            { id: 'admin_001',      email: 'admin@demo.com',      password: hashedPassword, role: ROLES.SUPER_ADMIN,       name: 'Global Admin',       status: 'active' },
            { id: 'retailer_001',   email: 'retailer@demo.com',   password: hashedPassword, role: ROLES.RETAILER_ADMIN,    name: 'Retailer Admin',     linked_entity_id: 'ret_001', status: 'active' },
            { id: 'advertiser_001', email: 'advertiser@demo.com', password: hashedPassword, role: ROLES.ADVERTISER,        name: 'Brand Manager',      linked_entity_id: 'adv_001', status: 'active' },
            { id: 'tech_001',       email: 'tech@demo.com',       password: hashedPassword, role: ROLES.TECH_OPERATOR,     name: 'Technical Support',  status: 'active' },
        ],
        campaigns: [
            {
                id: 'cmp_001',
