...
export class BaseRepository {
    constructor(collectionName) {
        ...
        this.breaker = new CircuitBreaker(`Firestore:${collectionName}`, {
            failureThreshold: 5,   // raised from 3 — cold-start jitter no longer trips the breaker
            resetTimeoutMs: 30000  // lowered from 60 s — faster self-healing after transient failures
        });
